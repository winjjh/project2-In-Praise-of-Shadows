...
function typeWriter() {
  if (i < txt.length) {
      document.querySelector(".one-animation").innerHTML += txt.charAt(i);
    i++;
...
function typeWriter() {
  if (i < txt.length) {
      document.querySelector(".two-animation").innerHTML += txt.charAt(i);
    i++;
    setTimeout(typeWriter, speed);
  }
}
...
function typeWriter() {
  if (i < txt.length) {
      document.querySelector(".three-animation").innerHTML += txt.charAt(i);
    i++;
    setTimeout(typeWriter, speed);
  }
}
